...
/**
 * This is the extension manager of the Smilesaddon extension.
 */
public class SmilesaddonManager extends GeneratedSmilesaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SmilesaddonManager.class.getName());
	 ...
	 */
	public static SmilesaddonManager getInstance()
	{
		return (SmilesaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SmilesaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SmilesaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SmilesaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SmilesaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SmilesaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
