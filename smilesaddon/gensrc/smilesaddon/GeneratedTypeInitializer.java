...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_customer_isDistributor();
			
				single_createattr_customer_distributor();
			

	}

	
	public void single_createattr_customer_isDistributor() throws JaloBusinessException
	{
	...
	public void single_createattr_customer_distributor() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_customer_isDistributor();
		
			single_setAttributeProperties_customer_distributor();
		
	}


		
						public void single_setAttributeProperties_customer_isDistributor() throws JaloBusinessException
						{
						...
						public void single_setAttributeProperties_customer_distributor() throws JaloBusinessException
						{
