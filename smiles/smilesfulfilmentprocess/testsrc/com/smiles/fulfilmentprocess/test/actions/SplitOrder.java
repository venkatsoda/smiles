 ...
 */
package com.smiles.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(SmilesFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SmilesFulfilmentProcessConstants.PARENT_PROCESS);
