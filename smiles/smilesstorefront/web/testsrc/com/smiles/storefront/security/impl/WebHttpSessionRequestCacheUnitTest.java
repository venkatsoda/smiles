...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/smilesstorefront/electronics/en",
						"https://electronics.local:9002/smilesstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/smilesstorefront/electronics/en",
						"https://electronics.local:9002/smilesstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/smilesstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/smilesstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/smilesstorefront/electronics/en",
						"https://electronics.local:9002/smilesstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/smilesstorefront",
						"https://electronics.local:9002/smilesstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/smilesstorefront",
						"https://electronics.local:9002/smilesstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/smilesstorefront/electronics/en",
						"https://electronics.local:9002/smilesstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
