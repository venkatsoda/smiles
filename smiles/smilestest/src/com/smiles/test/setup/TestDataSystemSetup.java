...
import com.smiles.test.constants.SmilesTestConstants;
import com.smiles.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SmilesTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/smilestest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/smilestest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/smilestest/import/cstickets.impex");
			...
			importImpexFile(context, "/smilestest/import/csquotes.impex");
		}
	}
}
