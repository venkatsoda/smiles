 ...
 */
package com.smiles.cockpits.setup;
...
import com.smiles.cockpits.constants.SmilesCockpitsConstants;
 ...
 */
@SystemSetup(extension = SmilesCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SmilesCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SmilesCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SmilesCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/smilescockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
